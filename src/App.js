...
const App = () => {
  ...
  // conversation is the varible saves all question/ answer pair
  ...
  const handleResp = (question, answer) => {
    ...
    // spread operator, spread all old conversation, then append new ones
  };
  ...
  return (
    <>
      <Layout style={{ height: "100vh", backgroundColor: "white" }}>
        ...
        >
          <Title style={{ color: "lime " }}>DocuMind AI</Title>
        </Header>
